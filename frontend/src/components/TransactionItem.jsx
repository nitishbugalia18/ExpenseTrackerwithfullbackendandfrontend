...
const TransactionItem = ({
  ...
  const IconComponent = categoryIcons[transaction.category] || categoryIcons.Other;

  return (
    <div className={containerClass || transactionItemStyles.container(isEditing, classes)}>
